...
/* GPIO Port B */
#define GPIOB_PDDR  (*((volatile unsigned int *)0x400FF054)) /* Data Direction */
#define GPIOB_PSOR  (*((volatile unsigned int *)0x400FF044)) /* Set   Output   */
#define GPIOB_PCOR  (*((volatile unsigned int *)0x400FF048)) /* Clear Output   */
